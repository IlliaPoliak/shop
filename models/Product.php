...
class Product
{
    ...
    public static function getLatestProducts($count = self::SHOW_BY_DEFAULT)
    {
        ...
        // Текст запроса к БД
        $sql = 'SELECT id, name, price, is_news FROM product '
        ...
        while ($row = $result->fetch()) {
            ...
            $productsList[$i]['is_news'] = $row['is_news'];
            $i++;
        }
        return $productsList;
    }
    ...
    public static function getProductsListByCategory($categoryId, $page = 1)
    {
        ...
        while ($row = $result->fetch()) {
            ...
            $products[$i]['is_news'] = $row['is_news'];
            $i++;
        }
        return $products;
    }
    ...
    public static function getRecommendedProducts()
    {
        ...
        // Получение и возврат результатов
        $result = $db->query('SELECT id, name, price, is_news FROM product '
    ...
    public static function updateProductById($id, $options)
    {
        ...
        $result->bindParam(':is_news', $options['is_news'], PDO::PARAM_INT);
    ...
    public static function createProduct($options)
    {
        ...
        $sql = 'INSERT INTO product '
                ...
                . 'description, is_news, is_recommended, status)'
                . 'VALUES '
                . '(:name, :code, :price, :category_id, :brand, :availability,'
                . ':description, :is_news, :is_recommended, :status)';
